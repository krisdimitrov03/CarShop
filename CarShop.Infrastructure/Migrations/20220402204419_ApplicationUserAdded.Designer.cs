...
namespace CarShop.Infrastructure.Data.Migrations
{
    ...
    [Migration("20220402204419_ApplicationUserAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarShop.Infrastructure.Data.WheelsType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CarShop.Infrastructure.Data.Car", b =>
                {
                    ...
                    b.HasOne("CarShop.Infrastructure.Data.WheelsType", "WheelsType")
                        .WithMany()
                        .HasForeignKey("WheelsTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
